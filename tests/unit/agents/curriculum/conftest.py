...
def sample_xlsx(tmp_path: Path) -> Path:
    ...
    ws.append([
        "LC Code", "Curriculum", "Subject", "Grade Level", "Key Stage",
        "Quarter", "Domain", "Subdomain", "Learning Competency",
        "Content Standard", "Performance Standard", "Source PDF",
    ])
    ws.append([
        "SCI10-PT-I-1", "MATATAG", "Science", "10", "KS4",
        "Q1", "Plate Tectonics", "Plate Boundaries",
    ...
    ws.append([
        "SCI10-PT-I-2", "MATATAG", "Science", "10", "KS4",
        "Q1", "Plate Tectonics", "Evidence",
    ...
    ws.append([
        "EN10LIT-I-1", "MATATAG", "English", "10", "KS4",
        "Q1", "Literary Text", None,
        "Analyze drama as expressions of communal values.",
        None, None, None,
    ])
    # G9 row — should be filtered out when grade_filter='10'
    ws.append([
        "MA9NS-I-1", "MATATAG", "Mathematics", "9", "KS3",
        "Q1", "Number Sense", None,
