...
- ``local_pdf`` — wraps :mod:`app.agents.ingest.pdf`.
- ``local_dataset`` — wraps :mod:`app.agents.ingest.csv_json`.
- ``direct_url`` — wraps :mod:`app.agents.ingest.web`.
...
def build_default_registry(settings: Settings) -> AdapterRegistry:
    ...
    """
    from app.agents.ingest.adapters.direct_url import DirectUrlAdapter
    from app.agents.ingest.adapters.local_pdf import LocalPdfAdapter
    ...
    from app.agents.ingest.adapters.wikipedia import WikipediaAdapter
